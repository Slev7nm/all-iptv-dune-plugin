...
> Конфиги неудобно редактирповать. Можете сделать с этим что-нибудь?
...
Мы тоже хотим чтобы нам помогали! Прямо сейчас нам нужен дизайнер, чтоб отрисовать иконки приложения и групп каналов. Пишите в telegram группу (@all_iptv_dune_plugin)[tg://resolve?domain=all_iptv_dune_plugin] или в (issues)[https://github.com/Slev7nm/all-iptv-dune-plugin/issues].
